...
import { handleRedirectResponse, provider } from "../../../identity/identity";
...
export default async function handler(
    ...
    try {
        const userData = await handleRedirectResponse(code, state, redirectUri, grantType);
        ...
        if (state?.length === 8) {
            ...
            pendingConnection.resolvedProvider = provider
