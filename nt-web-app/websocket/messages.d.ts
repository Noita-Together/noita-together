...
export namespace NT {
    ...
    class Envelope implements IEnvelope {
        ...
        /** Envelope kind. */
        public kind?: ("gameAction"|"lobbyAction"|"isMultiple");
    ...
    interface IGameAction {
        ...
        sStatUpdate?: (NT.IServerStatsUpdate|null);
    }
    ...
    class GameAction implements IGameAction {
        ...
        /** GameAction sStatUpdate. */
        public sStatUpdate?: (NT.IServerStatsUpdate|null);
    ...
    /** Represents a ServerStatsUpdate. */
    class ServerStatsUpdate implements IServerStatsUpdate {

        /**
         * Constructs a new ServerStatsUpdate.
         * @param [properties] Properties to set
         */
        constructor(properties?: NT.IServerStatsUpdate);
         ...
         * @param [properties] Properties to set
         * @returns ServerStatsUpdate instance
         */
        public static create(properties?: NT.IServerStatsUpdate): NT.ServerStatsUpdate;

        /**
         * Encodes the specified ServerStatsUpdate message. Does not implicitly {@link NT.ServerStatsUpdate.verify|verify} messages.
         * @param message ServerStatsUpdate message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: NT.IServerStatsUpdate, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a ServerStatsUpdate message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns ServerStatsUpdate
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): NT.ServerStatsUpdate;
         ...
         * @returns ServerStatsUpdate
         */
        public static fromObject(object: { [k: string]: any }): NT.ServerStatsUpdate;

        /**
         * Creates a plain object from a ServerStatsUpdate message. Also converts values to other types if specified.
         * @param message ServerStatsUpdate
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: NT.ServerStatsUpdate, options?: $protobuf.IConversionOptions): { [k: string]: any };
